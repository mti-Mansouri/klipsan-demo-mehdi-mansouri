  ...
  return (
    <main className=" w-screen min-h-screen py-[120px] flex px-[7%] justify-between">
      ...
      <section className=" h-full w-1/2 flex flex-col items-start gap-4">
       ...
       <p className="font-bebas font-bold text-3xl"><span>{"$ "+product.price.toFixed(2)}</span> {product.subscription && product.subscription}</p>
      ...
      defaultValue={1} type="number" /> 
       ...
       <div className="">
         ...
         theme="light">Add to Cart</ButtonKlipsan>
       </div>
      </section>
    </main>
  );
