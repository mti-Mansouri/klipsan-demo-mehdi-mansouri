export default function TermsPAge() {
  return (
    <main className="w-screen min-h-screen flex flex-col items-center  md:flex-row md:justify-between md:items-start pb-5 pt-[230px] px-[5%] bg-white text-black ">
      <p className="font-bebas font-bold text-[50px] text-center">TERMS OF SERVICE</p>
      <div className="flex max-w-[80%] md:max-w-[50%] flex-col  items-start gap-6  ">
        ...
        <p>
          ...
          more work to do.Be clear, be confident, and don’t overthink it. The
          beauty of your story is that it’s going to continue to evolve and your
          site can evolve with it. Your goal should be to make it feel right for
