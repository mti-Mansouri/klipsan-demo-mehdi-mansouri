export default function FaqsPage() {
  return (
    <main className="w-screen min-h-screen flex justify-between items-start pt-[230px] px-[5%] bg-white text-black ">
      <p className="font-bebas font-bold text-[50px]">FAQs</p>
      <div className="flex max-w-[50%] flex-col  items-start gap-6  ">
        <div className="font-bold text-lg">This is a frequently asked question?</div>
